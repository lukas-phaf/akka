...
Please refer to the GraphStage documentation @ref:[ for Scala](../../scala/stream/stream-customize.md#graphstage) or
the documentation @ref:[for Java](../../scala/stream/stream-customize.md#graphstage), for details on building custom GraphStages.
...
in @ref:[Operator Fusion](../../java/stream/stream-flows-and-basics.md#operator-fusion) (Java) and @ref:[Operator Fusion](../../scala/stream/stream-flows-and-basics.md#operator-fusion) (Scala).
...
More information can be found in the @ref:[documentation for Scala](../../scala/actors.md#coordinated-shutdown) or
@ref:[documentation for Java](../../java/actors.md#coordinated-shutdown)
...
@ref:[weakly_up_scala](../../scala/cluster-usage.md#weakly-up) is now enabled by default, but it can be disabled with configuration option:
...
is also supported. Read more in the documentation @ref:[for Scala](../../scala/cluster-sharding.md#cluster-sharding-mode) or
the documentation @ref:[for Java](../../java/cluster-sharding.md#cluster-sharding-mode).
...
Note that the stored @ref:[cluster_sharding_remembering_java](../../java/cluster-sharding.md#cluster-sharding-remembering) data with `persistence` mode cannot
