...
See @ref:[min-members_scala](cluster-usage.md#min-members) for more information about `min-nr-of-members`.
...
stored in @ref:[ddata_durable_scala](distributed-data.md#ddata-durable) of Distributed Data. You may want to change the
