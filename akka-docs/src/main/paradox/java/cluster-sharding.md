...
The state of the coordinator and the state of [cluster_sharding_remembering_java](#cluster-sharding-remembering) of the shards
...
See @ref:[min-members_java](cluster-usage.md#min-members) for more information about `min-nr-of-members`.
...
stored in @ref:[ddata_durable_java](distributed-data.md#ddata-durable) of Distributed Data. You may want to change the 
